  ...
  return (
    <main className="min-h-screen bg-[#F7F9FC] text-slate-900">
      <div className="relative mx-auto flex min-h-screen max-w-[1760px] flex-col overflow-hidden px-6 py-8 lg:px-10 lg:py-10">
        ...
        <div className="relative z-10 flex w-full flex-col items-center gap-5 pb-7 lg:pb-9">
          <Image
          ...
          <Link
            href="/enroll"
            className="group inline-flex items-center gap-3 rounded-full border border-brand-200 bg-brand-50 px-6 py-3 text-base font-bold text-brand-800 shadow-glow transition hover:-translate-y-0.5 hover:border-brand-300 hover:bg-brand-100 sm:px-8 sm:py-4 sm:text-lg"
          >
            <span className="flex h-8 w-8 items-center justify-center rounded-full bg-brand-600 text-white">+</span>
            <span>New here? Enroll your Company</span>
        ...
        <div className="relative z-10 flex flex-1 flex-col gap-8 overflow-hidden lg:flex-row lg:gap-10">
          <section className="relative flex w-full flex-col rounded-[44px] bg-white p-8 shadow-[0_30px_80px_-40px_rgba(15,23,42,0.35)] lg:w-[52%] lg:p-12">
            ...
            <div className="mb-10 max-w-[520px]">
              <h1 className="text-[45px] font-extrabold leading-[0.95] tracking-[-0.02em] text-[#0F172A]">
                Connected  <span className="text-[#1F64F2]">Workplace!</span>
              </h1>
          ...
          <section className="flex w-full flex-col rounded-[44px] bg-white p-8 shadow-[0_30px_80px_-40px_rgba(15,23,42,0.35)] lg:w-[48%] lg:p-12">
            ...
            <div className="mb-8">
              <h2 className="text-[42px] font-extrabold leading-[1.05] tracking-[-0.02em] text-slate-900">Welcome </h2>
        ...
        <div className="mt-8 flex items-center justify-center rounded-[32px] bg-white px-8 py-5 shadow-[0_20px_40px_-30px_rgba(15,23,42,0.25)]">
          <p className="text-xs text-slate-600">Employee Self-Service Portal</p>
        </div>
      </div>
    </main>
  );
